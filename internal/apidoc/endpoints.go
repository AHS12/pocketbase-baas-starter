...
func RegisterEndpoints(se *core.ServeEvent, generator *Generator) {
	...
	se.Router.GET("/api-docs/openapi.json", func(e *core.RequestEvent) error {
		...
		if err != nil {
			return response.InternalServerError(e, "Failed to generate OpenAPI specification", map[string]any{
				"details": err.Error(),
			})
		}
	...
	se.Router.GET("/api-docs/stats", func(e *core.RequestEvent) error {
		...
		if err != nil {
			return response.InternalServerError(e, "Failed to get collection statistics", map[string]any{
				"details": err.Error(),
			})
		}
	...
	se.Router.POST("/api-docs/invalidate-cache", func(e *core.RequestEvent) error {
		InvalidateCache()
		return response.OK(e, "Cache invalidated successfully", nil)
	})
	...
	se.Router.POST("/api-docs/check-collections", func(e *core.RequestEvent) error {
		...
		if invalidated {
			return response.OK(e, "Collections changed, cache invalidated", responseData)
		} else {
